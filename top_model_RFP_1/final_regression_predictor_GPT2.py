...
data_df = pd.read_csv("/home/atuin/b114cb/b114cb13/ESM_RFP_1/RFPs3_ESM_2small.csv")
column_of_interest_1 = "states.0.qy"
column_of_interest_2 = "states.0.em_max"
prediction_df = pd.read_csv("/home/atuin/b114cb/b114cb13/ESM_RFP_1/GPT2_library_500_ESM_small.csv")
output_csv = "predictions_GPT2_library_500_ESM_small_3.csv"
accept_negatives = "Y"
...
prediction_df.dropna(subset=["embedding"], inplace=True)
print("Shape after dropping:")
print(prediction_df.shape)
...
try:
    ...
    print("Error:", e)
    print("Problematic row:", prediction_df[prediction_df["embedding"].isnull()])
    raise e
...
if accept_negatives == "Y":
    plt.xlim(0, None)  # Set lower limit for x-axis at 0
    plt.ylim(550, None)  # Set lower limit for y-axis at 0
plt.legend()
plt.show()
